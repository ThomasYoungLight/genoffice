...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiToolRenderPreview: '读取工作表预览',
    aiToolReadCells: '读取单元格',
    aiToolReadCellsCount: '读取 {count} 个单元格',
    aiToolRawXml: '读取原始 XML',
    aiToolRawXmlEdit: '编辑原始 XML',
  ...
  en: {
    ...
    aiToolRenderPreview: 'Render sheet preview',
    aiToolReadCells: 'Read cells',
    aiToolReadCellsCount: 'Read {count} cells',
    aiToolRawXml: 'Read raw XML',
    aiToolRawXmlEdit: 'Edit raw XML',
  ...
  ja: {
    ...
    aiToolRenderPreview: 'シートのプレビューを描画',
    aiToolReadCells: 'セルを読み取り',
    aiToolReadCellsCount: 'セル {count} 個を読み取り',
    aiToolRawXml: '生 XML を読み取り',
    aiToolRawXmlEdit: '生 XML を編集',
  ...
  ko: {
    ...
    aiToolRenderPreview: '시트 미리보기 렌더링',
    aiToolReadCells: '셀 읽기',
    aiToolReadCellsCount: '셀 {count}개 읽기',
    aiToolRawXml: '원본 XML 읽기',
    aiToolRawXmlEdit: '원본 XML 편집',
  ...
  fr: {
    ...
    aiToolRenderPreview: 'Rendu de l’aperçu de la feuille',
    aiToolReadCells: 'Lire les cellules',
    aiToolReadCellsCount: 'Lire {count} cellules',
    aiToolRawXml: 'Lire le XML brut',
    aiToolRawXmlEdit: 'Modifier le XML brut',
  ...
  de: {
    ...
    aiToolRenderPreview: 'Blattvorschau rendern',
    aiToolReadCells: 'Zellen lesen',
    aiToolReadCellsCount: '{count} Zellen lesen',
    aiToolRawXml: 'Rohes XML lesen',
    aiToolRawXmlEdit: 'Rohes XML bearbeiten',
  ...
  es: {
    ...
    aiToolRenderPreview: 'Renderizar vista previa de la hoja',
    aiToolReadCells: 'Leer celdas',
    aiToolReadCellsCount: 'Leer {count} celdas',
    aiToolRawXml: 'Leer XML sin procesar',
    aiToolRawXmlEdit: 'Editar XML sin procesar',
  ...
  th: {
    ...
    aiToolRenderPreview: 'เรนเดอร์ตัวอย่างชีต',
    aiToolReadCells: 'อ่านเซลล์',
    aiToolReadCellsCount: 'อ่านเซลล์ {count} เซลล์',
    aiToolRawXml: 'อ่าน XML ดิบ',
    aiToolRawXmlEdit: 'แก้ไข XML ดิบ',
  ...
  id: {
    ...
    aiToolRenderPreview: 'Render pratinjau lembar',
    aiToolReadCells: 'Baca sel',
    aiToolReadCellsCount: 'Baca {count} sel',
    aiToolRawXml: 'Baca XML mentah',
    aiToolRawXmlEdit: 'Edit XML mentah',
  ...
  ru: {
    ...
    aiToolRenderPreview: 'Отрисовать предпросмотр листа',
    aiToolReadCells: 'Чтение ячеек',
    aiToolReadCellsCount: 'Чтение {count} ячеек',
    aiToolRawXml: 'Чтение исходного XML',
    aiToolRawXmlEdit: 'Правка исходного XML',
  ...
  ar: {
    ...
    aiToolRenderPreview: 'عرض معاينة الورقة',
    aiToolReadCells: 'قراءة الخلايا',
    aiToolReadCellsCount: 'قراءة {count} من الخلايا',
    aiToolRawXml: 'قراءة XML الخام',
    aiToolRawXmlEdit: 'تحرير XML الخام',
  ...
  pt: {
    ...
    aiToolRenderPreview: 'Renderizar pré-visualização da folha',
    aiToolReadCells: 'Ler células',
    aiToolReadCellsCount: 'Ler {count} células',
    aiToolRawXml: 'Ler XML bruto',
    aiToolRawXmlEdit: 'Editar XML bruto',
  ...
  it: {
    ...
    aiToolRenderPreview: 'Renderizza anteprima del foglio',
    aiToolReadCells: 'Lettura delle celle',
    aiToolReadCellsCount: 'Lettura di {count} celle',
    aiToolRawXml: 'Leggi XML grezzo',
    aiToolRawXmlEdit: 'Modifica XML grezzo',
  ...
  pl: {
    ...
    aiToolRenderPreview: 'Renderuj podgląd arkusza',
    aiToolReadCells: 'Odczyt komórek',
    aiToolReadCellsCount: 'Odczyt {count} komórek',
    aiToolRawXml: 'Odczyt surowego XML',
    aiToolRawXmlEdit: 'Edycja surowego XML',
  ...
  nl: {
    ...
    aiToolRenderPreview: 'Voorbeeld van blad weergeven',
    aiToolReadCells: 'Cellen lezen',
    aiToolReadCellsCount: '{count} cellen lezen',
    aiToolRawXml: 'Ruwe XML lezen',
    aiToolRawXmlEdit: 'Ruwe XML bewerken',
  ...
  ms: {
    ...
    aiToolRenderPreview: 'Render pratonton helaian',
    aiToolReadCells: 'Baca sel',
    aiToolReadCellsCount: 'Baca {count} sel',
    aiToolRawXml: 'Baca XML mentah',
    aiToolRawXmlEdit: 'Edit XML mentah',
  ...
  he: {
    ...
    aiToolRenderPreview: 'עיבוד תצוגה מקדימה של הגיליון',
    aiToolReadCells: 'קריאת תאים',
    aiToolReadCellsCount: 'קריאת {count} תאים',
    aiToolRawXml: 'קריאת XML גולמי',
    aiToolRawXmlEdit: 'עריכת XML גולמי',
  ...
  hi: {
    ...
    aiToolRenderPreview: 'शीट पूर्वावलोकन रेंडर करें',
    aiToolReadCells: 'सेल पढ़ें',
    aiToolReadCellsCount: '{count} सेल पढ़ें',
    aiToolRawXml: 'कच्चा XML पढ़ें',
    aiToolRawXmlEdit: 'कच्चा XML संपादित करें',
  ...
  'zh-TW': {
    ...
    aiToolRenderPreview: '轉譯工作表預覽',
    aiToolReadCells: '讀取儲存格',
    aiToolReadCellsCount: '讀取 {count} 個儲存格',
    aiToolRawXml: '讀取原始 XML',
    aiToolRawXmlEdit: '編輯原始 XML',
