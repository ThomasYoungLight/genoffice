...
24 tools, as the model sees them: the name it calls, the description it is given, and every argument its schema accepts.
...
| argument | type   | required | description                                                                                   |
| -------- | ------ | -------- | --------------------------------------------------------------------------------------------- |
| `label`  | string | yes      | Sequence label, e.g. Figure, Table, Equation. Captions sharing a label share a numbering run. |
| `text`   | string |          | Caption text after the number; optional                                                       |
...
| argument | type     | required | description   |
| -------- | -------- | -------- | ------------- |
| `terms`  | string[] | yes      | Terms to mark |
